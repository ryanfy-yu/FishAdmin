...
namespace FishManagementSystem.Server.Controllers.Role
{
    /// <summary>
    /// 系统用户
    /// </summary>
    ...
    public class SystemRoleController : FishControllerBase
    {
        ...
        public SystemRoleController(ISystemUsersDataService dataService, IMapper mapper, ILogger<SystemRoleController> logger) : base(logger, mapper)
        {
        ...
        public ApiResult Get([FromQuery] ReqPaginationDto dto)
        {
            ...
            try
            {
                ...
                var data = _dataService.Get<TSystemRole>(dto.CurrentPage, dto.PageSize, ref total, ref totalPages, conModels, orderList);
        ...
        {
            var result = _dataService.Add<TSystemRole>(dto);
        ...
        {
            var result = _dataService.Update<TSystemRole>(dto);
        ...
        {
            var result = _dataService.Delete<TSystemRole>(id);
